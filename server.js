...
// Import du app.js express 
const app = require('./app');


// Parametrage du port pour express
// app.set('port', process.env.PORT || 3000);

// Creation du serveur en passant une fonction executer a chaque appel du server
// la fonction recoit les objets request et response en argument de app.js
